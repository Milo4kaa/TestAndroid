...
import com.example.todolist.databinding.ActivityNoteBindingImpl;
import com.example.todolist.databinding.NoteItemBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_ACTIVITYNOTE = 2;

  private static final int LAYOUT_NOTEITEM = 3;

  private static final SparseIntArray INTERNAL_LAYOUT_ID_LOOKUP = new SparseIntArray(3);

  static {
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.example.todolist.R.layout.activity_main, LAYOUT_ACTIVITYMAIN);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.example.todolist.R.layout.activity_note, LAYOUT_ACTIVITYNOTE);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.example.todolist.R.layout.note_item, LAYOUT_NOTEITEM);
  }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      ...
      sKeys.put("layout/activity_note_0", com.example.todolist.R.layout.activity_note);
      sKeys.put("layout/note_item_0", com.example.todolist.R.layout.note_item);
    }
  }
}
